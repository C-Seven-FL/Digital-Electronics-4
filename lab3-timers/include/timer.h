...
#define TIM0_OVF_16mS   TCCR0B &= ~((1<<CS12) | (1<<CS11)); TCCR0B |= (1<<CS10);
/** @brief Set overflow 128mS, prescaler 010 --> 8 */
#define TIM0_OVF_128mS  TCCR0B &= ~((1<<CS12) | (1<<CS10)); TCCR0B |= (1<<CS11);
...
/** @brief Set overflow 16mS, prescaler 001 --> 1 */
#define TIM2_OVF_16mS   TCCR2B &= ~((1<<CS12) | (1<<CS11)); TCCR2B |= (1<<CS10);
/** @brief Set overflow 128mS, prescaler 010 --> 8 */
#define TIM2_OVF_128mS  TCCR2B &= ~((1<<CS12) | (1<<CS10)); TCCR2B |= (1<<CS11);
/** @brief Set overflow 512mS, prescaler 011 --> 32 */
#define TIM2_OVF_512mS  TCCR2B &= ~((1<<CS12) | (1<<CS10)); TCCR2B |= (1<<CS11);
/** @brief Set overflow 1ms, prescaler 100 --> 64 */
#define TIM2_OVF_1MS TCCR2B &= ~(1<<CS12); TCCR2B |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 2ms, prescaler ... --> 128 */
#define TIM2_OVF_2MS TCCR2B &= ~(1<<CS12); TCCR2B |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 4ms, prescaler 100 --> 256 */
#define TIM2_OVF_4MS  TCCR2B &= ~((1<<CS11) | (1<<CS10)); TCCR2B |= (1<<CS12);
/** @brief Set overflow 16ms, prescaler // 101 --> 1024 */
#define TIM2_OVF_16MS  TCCR2B &= ~(1<<CS11); TCCR2B |= (1<<CS12) | (1<<CS10);
